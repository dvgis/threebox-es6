...
Threebox contains [15 examples](https://github.com/jscastro76/threebox/tree/master/examples) to showcase most of its features. Check them out to have a glance of what is possible.
